...
|---|---|
| [features.md](features.md) | The agreed feature scope, with details and open questions per feature |
| [architecture.md](architecture.md) | Components, process and privilege model, how config flows from the DB to Asterisk |
