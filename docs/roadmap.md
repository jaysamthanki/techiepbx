...
| 18 | Call reports | F5 | **Built 2026-09-22, pending lab verification** (D131). AMI Cdr collection into `Cdrs` (025), Reports page with leg-level history, totals per extension/trunk, CSV export, Today/Yesterday/This week/Last week quick buttons. Lab needs: apply + Asterisk restart (loads `cdr_manager`), then a real call through the report. |
